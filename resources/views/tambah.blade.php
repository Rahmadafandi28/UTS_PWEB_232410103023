            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-success text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-plus-circle me-2"></i>Tambah Data Sampah
                        </h4>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('submit') }}" method="POST" id="tambahDataForm">
                        @csrf
                        <!-- Kategori -->
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg" id="Contoh_Barang" name="Contoh_Barang" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-lg" id="Cara_Pemilahan" name="Cara_Pemilahan" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg" id="Tempat_Pembuangan" name="Tempat_Pembuangan" 
